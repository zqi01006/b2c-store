package com.zqi.product.serivce.impl;
...
import com.zqi.pojo.Picture;
import com.zqi.pojo.Product;
import com.zqi.product.mapper.PictureMapper;
import com.zqi.product.mapper.ProductMapper;
...
public class ProductServiceImpl extends ServiceImpl<ProductMapper,Product> implements ProductService {
    ...
    /**
     * 单类别名称 查询热门商品 至多查询7条数据
     *      1、根据类名查询 调用feign客户端访问类别服务获取类别的数据
    ...
    public R promo(String categoryName) {
        r = categoryClient.byName(categoryName);
        ...
        //返回的是包装数据！内部有对应的商品集合，也有分页的参数 例如：总条数，总页数
    ...
    public void subNumber(List<OrderToProduct> orderToProducts) {
        ...
        Map<Integer,OrderToProduct> map = orderToProducts.stream()
                .collect(Collectors.toMap(OrderToProduct::getProductId,item->item));
        //获取商品的id集合
        ...
        //批量更新
        this.updateBatchById(productList);//继承IService可用此操作
        log.info("ProductServiceImpl.subNumber业务结束，结果：{}","销售量和库存量修改完毕");
    }
